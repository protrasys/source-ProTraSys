...
class AuthService {
  public _auth: any;
  public _facultyAuth: any;
  public _adminAuth: any;
  constructor() {
  ...
  async login(enrollmentId: string, password: string) {
  ...
  async FacultyLogin(enrollmentId: string, password: string) {
  ...
  async AdminLogin(AID: string, password: string) {
