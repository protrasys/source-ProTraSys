...
const Footer = () => {
    ...
    return(
        <Box variant="div" container className={classes.center}>
            <Typography variant="h3" className={classes.heading}>
                Test ProTraSys for FREE!
            </Typography>
            <Typography variant="p" className={classes.para}>
                BETA version is out! Try it now for a limited time.<br/>
                No credit card required - only your curiosity and goodwill.<br/>
            </Typography> 
